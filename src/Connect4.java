...
public class Connect4 {
	...
	implements ActionListener {//creating own button class
		...
		public void actionPerformed(ActionEvent e) { // placing x or o's
            ...
            if((xOrO%2)==0 && getText().equals(" ") && win==false){
                ...
                buttons[pos].setBackground(Color.BLACK);
                buttons[pos].setForeground(Color.BLACK);
            }
        ...
        if((xOrO%2)==1 && win==false) {
            ...
            if(buttons[pos].getText().equals(" ")){
               letter = "Red";
               buttons[pos].setText("X"); //minimax agent always play Red
               buttons[pos].setOpaque(true);
	...
	public static void clearButtons(){
		...
		for(int i=0; i<=41; i++){// clear all 42 buttons
			buttons[i].setText(" ");	
